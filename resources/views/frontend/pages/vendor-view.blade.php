                ...
                <ul class="list-inline mb-0 text-center text-lg-left">
                    <li class="list-inline-item ">
                        <a class="text-reset d-inline-block fw-600 fs-15 p-3  border-bottom border-primary border-width-2 "
                            href="{{ route('FrrontendShopView',$vendor->slug) }}">Store Home</a>
                    </li>
                    <li class="list-inline-item ">
...
<section class="mb-5">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <div class="aiz-carousel gutters-10 slick-initialized slick-slider" data-items="6" data-xl-items="5"
                    data-lg-items="4" data-md-items="3" data-sm-items="2" data-xs-items="2" data-autoplay="true"
                    ...
                    {{-- <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5"
                        ...
                        @endphp
                        @Forelse ($Featured as $latest_product)
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="absolute-top-right aiz-p-hov-icon">
                                        ...
                                        <a href="javascript:void(0)"
                                            onclick="showAddToCartModal({{$latest_product->id}})" data-toggle="tooltip"
