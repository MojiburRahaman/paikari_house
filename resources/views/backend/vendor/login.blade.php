...
<body>
    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="" method="post" id="vendorSignup">
                ...
                <span class="error pass_confirm_err"></span>
                <button>Sign Up</button>
            </form>
        </div>
        <div class="form-container sign-in-container">
            <form action="{{route('VendorLoginPost')}}" method="POST">
                @csrf
                <h1>Sign in</h1>
                <input type="email" name="email" placeholder="Email" />
                <input type="password" name="password" placeholder="Password" />
    ...
    <script src="https://bdmuscle.com/front/js/vendor/jquery-2.2.4.min.js"
        integrity="sha256-ZosEbRLbNQzLpnKIkEdrPv7lOy9C27hHQ+Xp8a4MxAQ=" crossorigin="anonymous"></script> --}}
    ...
    <script>
        @if (session('alert'))
            Command: toastr["warning"]('{{session('alert')}}')
            @endif
...
jQuery(document).ready(function($) {
        $("#vendorSignup").submit(function(e) {
            $('.name_err').text('');
          $('.email_err').text('');
          $('.pass_err').text('');  
