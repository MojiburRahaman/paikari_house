...
Route::middleware(['auth:web',])->group(function () {
    ...
    Route::get('/purchase-history', [UserProfileController::class, 'UserPurchase'])->name('UserPurchase');
    Route::get('/purchase-history/{id}', [UserProfileController::class, 'UserOrderDetails'])->name('UserOrderDetails');
...
Route::get('/track-order', [FrontendController::class, 'OrderTrack'])->name('OrderTrack');
Route::post('/track-order', [FrontendController::class, 'FrontendOrdeTrackPost'])->name('FrontendOrdeTrackPost');
